...
import type { SkillLoadDiagnostic, SkillScope } from "./contracts";
...
export function resolveConfiguredSkillRoots(): ResolvedSkillRoots {
  return resolveSkillRoots(getWorkspaceFsPolicy().getRoot(), resolveGlobalJellyDir());
}
