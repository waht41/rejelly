...
import type { SkillRecord, SkillRuntimeSnapshot } from "./contracts";
import { qualifiedSkillName } from "./contracts";
import { SKILL_LIMITS } from "./limits";
import { renderSkillToolResult } from "./skillToolOutput";
...
export function resolveExplicitSkills(
  ...
  for (const reference of references.slice(0, SKILL_LIMITS.explicitSkillsPerTurn)) {
