...
export function buildUnifiedSystemPrompt(options?: {
  ...
  builder.addList(
    [
      ...
      "If mcp_reference returns unavailableServers, report each structured status and follow its suggestedAction. Do not retry synonyms: untrusted, pending, failed, and disabled are availability states, not search misses.",
